...
function colors(color) {
  ...
  if(color === 'blue') {return 'This is blue';} else if(color === 'red')
{return 'This is red';} else if(color === 'green') {return 'This is green';} else if(color === 'orange') {return 'This is orange';} else {return 'Color not found';}
}
